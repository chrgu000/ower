...
HAVING COUNT(star_level)=3 
 ...
 SELECT user_code,star_level,medal_level,star_date FROM user_star_log WHERE star_date BETWEEN ('2018-09')AND ('2018-12') #AND user_code='806180'
...
WHERE m.user_code='805720' AND
 m.gen_time BETWEEN UNIX_TIMESTAMP('2018-09-01 00:00:00')AND UNIX_TIMESTAMP('2018-12-31 23:59:59')
